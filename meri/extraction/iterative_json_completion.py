...
from ..utils.llm_utils import chat_completion_request
from ..prompts.prompts import generate_self_supervised_json_population_prompt
import json
import tqdm
...
class IterativeJsonPopulator:
    ...
    def __init__(self, json_schema_str: str, strategy: IterativePopulationStrategies, n_rounds=3, model = 'gpt-4o-mini', temp=0.3, api_key: str = None) -> None:
